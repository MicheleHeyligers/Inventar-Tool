                                                ...
                                                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper form-inline dt-bootstrap"> 
                                                    ...
                                                    echo "<table class='table table-striped table-bordered dataTable' id='DataTables_Tables_0' aria-describedby='DataTables_Table_0_info' role='grid'>";
                                                        ...
                                                        if(isset($_GET["seriennr"])){  
                                                            $seriennr_delete = $_GET["seriennr"];    
                                                            if(!empty($seriennr_delete)){
                                                                // sql-query to delete data
                                                                $sql_delete = "DELETE FROM geraet WHERE Seriennr ='".$seriennr_delete."'";
                                                                ...
                                                                if($num > 0){
                                                                    echo "<script>
                                                                        ...
                                                                        document.getElementById('sql_check').innerHTML ='Datensatz wurde gelöscht.';
                                                                        </script>";
                                                                }
                                                                else {
                                                                    echo "<script>
                                                                        ...
                                                                        document.getElementById('sql_check').style.fontWeight = 'bold';
                                                                        document.getElementById('sql_check').innerHTML ='Fehler im SQL-Statement, Daten wurden nicht gelöscht!';
                                                                        </script>";
                                                                } 
                                                            }
                                                        }     

                                                        // check customername and show remaining data
                                                        if(isset($_GET["custname"])){  
                                                            $customername = $_GET["custname"];    
                                                            if(!empty($customername)){
