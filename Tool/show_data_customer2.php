                ...
                <div class="side-menu-area">
                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        <li class="menu-title" style="font-size:1.1em">
                            <a href="show_data_customer.php?firma=<?php $firma=$_GET['firma']; echo $firma;?>" style="font-weight:700;text-transform:uppercase;padding:0px;">Übersicht</a>
                        </li>
                        <li class="treeview">
                                    ...
                                    <div class="box-body">
                                        <div>
                                            <div class="box-header mb-30">
                                                <h5 id ="eins" class="box-title mb-3">Inventarliste: <?php echo $_GET["devicetyp"];?></h5>
                                                <?php 
                                                    // Variablen abfragen
                                                    if(isset($_GET["firma"])){  
                                                ...
                                                <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                                                    ...
                                                    if(isset($_GET["firma"])){  
                                                        ...
                                                        if(!empty($customername)){
                                                            ...
                                                            $sql  = "SELECT geraet.Bezeichnung, geraet.CPU, geraet.HDD_SSD_Kapazitaet AS 'Festplattenspeicher', geraet.RAM, geraet.Seriennr, geraet.BS, geraet.Anschaffung 
                                                                        FROM geraet, kunde, geraetetyp
                                                                        WHERE kunde.Kunden_ID = geraet.Kunden_ID 
                                                                        AND geraetetyp.Typ_ID = geraet.Typ_ID 
                                                                        AND geraetetyp.geraeteart= '".$_GET["devicetyp"]."'
                                                                        AND kunde.Firma ='".$customername."'";
