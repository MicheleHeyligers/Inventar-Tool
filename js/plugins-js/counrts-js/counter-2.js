...
var $pb = $('.vc_progress_bar').parent(),
        $sb = $('.vc_single_bar'),
        $countersContainer = $('<div class="counters-container">');
    if ($pb.length) {
        $sb.each(function () {
                var $text = $(this).children('.vc_label').text(),
                    val = $(this).children('.vc_bar').data('value'),
                    color = $(this).children('.vc_bar').css('background-color');
                ...
                .append(
                    $('<div>', {
                        ...
                        .html($('<span>')),
                    $('<span>', {class: 'counter-text'}).text($text)
                );
    ...
    function initPieChart(){
        ...
        var windowScrollTop = $window.scrollTop(),
            ...
            window_2_3_height = windowHeight / 3,
            scrollTopAnd_2_3 = windowScrollTop + window_2_3_height,
            counterScrollFromTop = $countersContainer.position().top;
        ...
        console.log(
          ...
          'counterParrent: ' , $countersContainer
        );
